...
boo.addEventListener('click', function() {  // wir registrieren auf das click event des boo buttons folgenden code 
...
duck.addEventListener('click', function() { //analog
  if (on && playing) {
    playerOrder.push(3);
    check();
    three();
...
boing.addEventListener('click', function() { //analog
  if (on && playing) {
    playerOrder.push(4);
    check();
    four();
...
applause.addEventListener('click', function()  {//analog
  if (on && playing) {
    playerOrder.push(5);
    check();
    five();
